  ...
  return (
    <div
      ...
      style={{
        ...
        minWidth: window.innerWidth < 768 ? 'auto' : (isTable ? '500px' : '400px'),
        maxWidth: window.innerWidth < 768 ? '95vw' : `${popoverWidth}px`,
        height: window.innerWidth < 768 ? 'auto' : `${popoverHeight}px`,
        minHeight: window.innerWidth < 768 ? 'auto' : '250px',
        maxHeight: window.innerWidth < 768 ? '85vh' : `${popoverHeight}px`,
        overflow: 'hidden',
        overflowY: 'auto',
